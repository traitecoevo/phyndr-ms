...
\caption{Overlap (purple) of species with recognized names (yellow), trait data in the global woodiness data base \citep[red][]{Zanne, FitzJohn2014}, and placement in the phylogenetic tree of \citet{Zanne} (blue). The total diversity of plants (grey) is not known.}
\label{fig:venn}
\end{figure}

...
\caption{Overlap (purple) of species with recognized names (yellow), trait data in the global woodiness data base \citep[red][]{Zanne, FitzJohn2014}, and which have sequences deposited in \textsc{GenBank} (blue) (All, as of May 2015). The total diversity of plants (grey) is not known.}
\label{fig:venn}
\end{figure}
